...
MapGroup_HighTech:
	map HighTechWestRoute, TILESET_HIGHTECH, ROUTE, LANDMARK_HIGHTECH_WEST_ROUTE
	map HighTechWestRouteOcean, TILESET_HIGHTECH, ROUTE, LANDMARK_HIGHTECH_WEST_ROUTE_OCEAN
	map HighTech, TILESET_HIGHTECH, TOWN, LANDMARK_HIGHTECH
	map HighTechWestRouteGate, TILESET_GATE, GATE, LANDMARK_HIGHTECH_WEST_ROUTE_OCEAN
	map HighTechPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_HIGHTECH
	map HighTechPokecenter2F, TILESET_POKECENTER, INDOOR, LANDMARK_HIGHTECH
	map HighTechLeague1F, TILESET_TOWER, INDOOR, LANDMARK_HIGHTECH
	map HighTechLeague2F, TILESET_GYM, INDOOR, LANDMARK_HIGHTECH
	map HighTechMart, TILESET_MART, INDOOR, LANDMARK_HIGHTECH
	map HighTechHouse1, TILESET_HOUSE, INDOOR, LANDMARK_HIGHTECH
	map HighTechHouse2, TILESET_HOUSE, INDOOR, LANDMARK_HIGHTECH
	map HighTechImposterOakHouse, TILESET_HOUSE, INDOOR, LANDMARK_HIGHTECH
	map HighTechAquarium1F, TILESET_AQUARIUM, INDOOR, LANDMARK_HIGHTECH
	map HighTechAquarium2F, TILESET_AQUARIUM, INDOOR, LANDMARK_HIGHTECH
...
MapGroup_Sugar:
	map SugarRoute, TILESET_HIGHTECH, ROUTE, LANDMARK_SUGAR_ROUTE
	map Sugar, TILESET_HIGHTECH, TOWN, LANDMARK_SUGAR
...
MapGroup_Blue:
	map BlueForestRoute1, TILESET_COLD_ZONE, ROUTE, LANDMARK_BLUE_FOREST_ROUTE_1
	map BlueForestRoute2, TILESET_COLD_ZONE, ROUTE, LANDMARK_BLUE_FOREST_ROUTE_2
	map BlueForestRoute3, TILESET_COLD_ZONE, ROUTE, LANDMARK_BLUE_FOREST_ROUTE_3
	map BlueForest, TILESET_COLD_ZONE, TOWN, LANDMARK_BLUE_FOREST
...
MapGroup_North:
	map North, TILESET_COLD_ZONE, TOWN, LANDMARK_NORTH
