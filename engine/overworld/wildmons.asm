...
.blocks
	db COLL_FLOOR | COLL_FLAG
	db COLL_GRASS | COLL_FLAG
	db COLL_WATER_20 | COLL_FLAG
	db COLL_WATER | COLL_FLAG
	db COLL_OLD_WATERFALL | COLL_FLAG
	db COLL_OLD_HOTSPRING | COLL_FLAG
	db COLL_OLD_42 | COLL_FLAG
	db COLL_OLD_43 | COLL_FLAG
	db COLL_OLD_WHIRLPOOL | COLL_FLAG
	db -1
